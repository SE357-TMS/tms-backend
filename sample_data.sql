...
VALUES
    ...
    (
        UNHEX(REPLACE(UUID(), '-', '')),
        'admin',
        '$2a$12$zuriztglmw7FGNOgsgnP7uGDbR4ksnA2aUMEa6oEgTTdZRKMyD7bK',
        0,
        'Nguyễn Văn Admin',
        'admin@tms.com',
        '0901234567',
    ...
    (
        ...
        'mai.do@gmail.com',
        '0956789012',
        '987 Nguyễn Thị Minh Khai, Q1, TP.HCM',
        '1997-11-30',
        'F',
        'CUSTOMER',
        NOW(),
...
FROM
    ...
    attraction a
WHERE
    r.route_name = 'Tour Hà Nội - Hạ Long'
    AND a.name = 'Chùa Một Cột';
...
FROM
    ...
    attraction a
WHERE
    r.route_name = 'Tour Nha Trang - Đà Lạt'
    AND a.name = 'Bãi biển Nha Trang';
...
FROM
    ...
    attraction a
WHERE
    r.route_name = 'Tour Đà Nẵng - Hội An'
    AND a.name = 'Phố cổ Hội An';
...
FROM
    ...
    attraction a
WHERE
    r.route_name = 'Tour Sài Gòn - Vũng Tàu'
    AND a.name = 'Dinh Độc Lập';
...
FROM
    ...
    attraction a
WHERE
    r.route_name = 'Tour Phú Quốc'
    AND a.name = 'Đảo Phú Quốc';
...
FROM
    route
WHERE
    route_name = 'Tour Sài Gòn - Vũng Tàu';
...
FROM
    route
WHERE
    route_name = 'Tour Hà Nội - Hạ Long';
...
FROM
    route
WHERE
    route_name = 'Tour Nha Trang - Đà Lạt';
...
FROM
    route
WHERE
    route_name = 'Tour Đà Nẵng - Hội An';
...
FROM
    ...
    user u
WHERE
    t.departure_date = '2025-01-15'
    AND u.username = 'customer01';
...
FROM
    ...
    user u
WHERE
    t.departure_date = '2025-02-10'
    AND u.username = 'customer03';
...
FROM
    ...
    user u
WHERE
    t.departure_date = '2025-03-05'
    AND u.username = 'customer04';
...
WHERE
    u.username = 'customer01'
    AND t.departure_date = '2025-01-15';
...
FROM
    ...
    JOIN trip t ON tb.trip_id = t.id
WHERE
    u.username = 'customer03'
    AND t.departure_date = '2025-02-10';
...
WHERE
    u.username = 'customer02'
    AND t.departure_date = '2024-12-01';
...
FROM
    ...
    JOIN trip t ON tb.trip_id = t.id
WHERE
    u.username = 'customer04'
    AND t.departure_date = '2025-03-05';


-- Invoice cho booking CONFIRMED (2025-05-10) - theo Option A: CONFIRMED => PAID
INSERT INTO
    invoice (
        id,
        booking_id,
...
WHERE
    u.username = 'customer01'
    AND t.departure_date = '2025-05-10';
...
WHERE
    u.username = 'customer01'
    AND r.route_name = 'Tour Hà Nội - Hạ Long';
...
WHERE
    u.username = 'customer03'
    AND r.route_name = 'Tour Đà Nẵng - Hội An';
...
WHERE
    u.username = 'customer04'
    AND r.route_name = 'Tour Phú Quốc';
